  ...
  const handleAuth = async (type: 'signin' | 'signup') => {
    ...
    toast({
      ...
      description: type === 'signin' 
        ...
        : "Your account has been created. Welcome to StoreForge AI!",
    });
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="signin-email" type="email" placeholder="Enter your email" className="pl-9" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="signin-password" type="password" placeholder="Enter your password" className="pl-9" />
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="signup-name" placeholder="Enter your full name" className="pl-9" />
                </div>
              </div>
